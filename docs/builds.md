...
## Auf einen Blick: Welche Waffe für welchen Boss?
...
### Stat-Priorität nach Build-Typ

| Build | Priorität 1 | Priorität 2 | Priorität 3 |
|-------|:-----------:|:-----------:|:-----------:|
| ⚡ Burst | Krit. Schaden | Angriffskraft | Krit. Trefferrate |
| 🛡️ Sustain | Parade-Schaden | Stagger-Aufbau | Ausdauer |
| 🎯 Safe | Überleben | Angriffskraft | Ausweichen |

---

## Innere Kampfkünste (Mystic Arts) – Ranking

| Rang | Mystic Art | Einsatz |
|:----:|-----------|---------|
| ⭐⭐⭐ | **Meridian Touch** | Universell – fast jeder Build profitiert |
| ⭐⭐⭐ | **Guardian Palm** | Überlebensfähigkeit für aggressive und defensive Builds |
| ⭐⭐ | **Cloud Steps** | Extra-Mobilität für Positionierung |
| ⭐⭐ | **Leaping Toad** | Situativ nützlich (AoE, Launch) |

---

> 💡 **Tipp:** Für die meisten Bosse reicht es, eine DPS-Waffe + Panacea Fan als Sekundär dabei zu haben. Den Wechsel zwischen den Waffen für Heilungspausen nutzen!
